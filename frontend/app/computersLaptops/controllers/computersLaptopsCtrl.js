...
['$scope', '$state', '$stateParams', '$sce', 'computersLaptopsService',
	function ($scope, $state, $stateParams, $sce, computersLaptopsService) {
	    ...
	    var adsIframePartOne = '//ws-na.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&MarketPlace=US&Operation=GetAdHtml&TemplateId=SrchWdgt&region=US&marketplace=amazon&tracking_id=onlshohub-20&auto_complete=true&search_type=search_widget&link_id=IMQCQDJSLB5I3662&width=1186&height=610&default_search_category=PCHardware&default_search_key=';
	        ...
	        computersLaptopsService.getProductDataBySearch().get(form).$promise.then(
                function (response) {
                    ...
                    if (response.data.length > 0) {
                        $scope.noResult = false;
                        var metaTitle = 'All for you | Computers Laptops ' + $stateParams.title;
